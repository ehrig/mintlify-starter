...
- `$config` _(array)_: An empty array by default. Define only the specific configurations you need, which will override the builder's default settings.

**Return:**

- _(array)_: The custom configuration array, applied alongside or in place of Bricks' defaults.
