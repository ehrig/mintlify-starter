...
This filter is used within the **[Create post](https://academy.bricksbuilder.io/article/create-update-posts-on-the-frontend/)** form action in Bricks.
...
In this example, the filter modifies the value of the meta key 'my\_meta\_key' using a custom function `transform_meta_value`.
