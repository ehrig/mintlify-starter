...
There is also a `[justify-content](https://academy.bricksbuilder.io/article/justify-content-control/)` control to allow users to set the alignment along the main axis of your CSS flexbox layout:
